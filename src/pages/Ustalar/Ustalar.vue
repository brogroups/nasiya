<template>
 <div class="header">
 <h2>Ustalar</h2>
  <button @click="showUstaModel = true" class="fetch-btn">Usta yaratish</button>
 </div>
 ...
 <UstaModel v-if="showUstaModel" @close="showUstaModel = false"/>
</template>
